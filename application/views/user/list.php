	...
	<div class="container">
		<div class="row fullscreen d-flex align-items-center justify-content-center">
			<div class="banner-content col-lg-8">
				...
				<h3 class="text-white">PERBANDINGAN ALGORITMA DEMPSTER SHAFER DAN ALGORITMA CERTAINTY FACTOR PADA SISTEM PAKAR DIAGNOSA HAMA DAN PENYAKIT PADA TANAMAN SEMANGKA BERBASIS WEB</h3>
				<p class="pt-20 pb-20 text-white">
					
				</p>
				<a href="<?= base_url('konsultasi') ?>" class="primary-btn text-uppercase">Mulai Konsultasi</a>
			</div>											
		</div>
	</div>					
</section>
